...
|-----------|--------|-------------|
| Framing Language | 25% | Word choices that signal perspective |
| Policy Positioning | 25% | Stance on political issues |
| Entity Sentiment | 20% | How political figures are described |
| Source Attribution | 15% | Which sources are cited |
| Topic Emphasis | 15% | What's emphasized or omitted |
...
### Approach
1. **Show your work** - Display individual dimension scores, not just final
2. **Acknowledge uncertainty** - Clear confidence indicators
3. **Explain methodology** - Link to detailed explanation
4. **Avoid inflammatory language** - "Left-leaning" not "biased"
5. **Neutral presentation** - No red/blue colors, balanced labels

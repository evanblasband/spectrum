      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="flex-1 relative z-[100]" ref={dropdownRef}>
          ...
          {showDropdown && history.length > 0 && (
            <div className="absolute z-50 top-full left-0 right-0 mt-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg max-h-80 overflow-y-auto">
                ...
                {history.map((item) => (
                  <li key={item.url + item.searchedAt}>
                    <button
                      ...
                      className="w-full px-3 py-2 text-left hover:bg-slate-50 dark:hover:bg-slate-700/50 flex items-start gap-3 group"
                    >
